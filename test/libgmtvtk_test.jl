...
const _TEST_SYMBOLS = (
	...
	:gmtvtk_symbol_click_jitter_test, :gmtvtk_symbol_layer_test, :gmtvtk_symbol_remove_test, :gmtvtk_seismicity_send_test, :gmtvtk_active_axes_test, :gmtvtk_symbol_table_test,
