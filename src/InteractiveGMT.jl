...
include("ecmwf.jl")      # Satellite > Copernicus > ERA5 / ECMWF download (GMT.jl ecmwf / era5vars / era5time)
include("ecv.jl")        # Satellite > Copernicus > Essential Climate Variables (CDS ecv-for-climate-change)
include("sentinelhub.jl")# Satellite > Copernicus > Sentinel Hub imagery (port of the QGIS SentinelHub plugin)
