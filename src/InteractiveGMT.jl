...
include("ecv.jl")        # Geophysics > Copernicus > Essential Climate Variables (CDS ecv-for-climate-change)
include("sentinelhub.jl")# Geophysics > Copernicus > Sentinel Hub imagery (port of the QGIS SentinelHub plugin)
