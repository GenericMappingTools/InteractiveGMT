...
const _LIB_SYMBOLS = (
	...
	:gmtvtk_promote_surface_h, :gmtvtk_replace_base_grid_h, :gmtvtk_show_layer_image_h, :gmtvtk_remove_grid_h, :gmtvtk_set_transplant_undo,
	...
	:gmtvtk_cube_flat_mode, :gmtvtk_mark_cube,
	:gmtvtk_scene_state,
