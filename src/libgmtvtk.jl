...
const _LIB_SYMBOLS = (
	...
	:gmtvtk_open_empty, :gmtvtk_open_empty_offscreen,
	:gmtvtk_busy_show, :gmtvtk_busy_close,      # the app's ONE busy notice (no-dead-time law)
	:gmtvtk_set_drop_callback, :gmtvtk_set_paste_callback, :gmtvtk_add_surface_h,
