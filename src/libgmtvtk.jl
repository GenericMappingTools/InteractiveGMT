...
const _LIB_SYMBOLS = (
	...
	:gmtvtk_set_dimfun_callback, :gmtvtk_set_nswing_callback, :gmtvtk_set_seismicity_callback,
	...
	:gmtvtk_set_focal_callback, :gmtvtk_add_meca_h, :gmtvtk_add_text_h, :gmtvtk_add_texts_h,
