...
function _ensure_callbacks()
	...
	for (name, fn) in (("qsc-warp",    _push_qsc_warp),   # Cube view mode's +proj=qsc table (qsccube.jl)
	                    ...
	                    ("igrf-point",  _register_igrf_point),
	                    ...
	                    ("grdfft",      _register_grdfft),
	                    ("grdhisteq",   _register_grdhisteq),
	                    ("xyz2grd",     _register_xyz2grd),
	                    ("grdfill",     _register_grdfill),
	                    ("trend2d",     _register_trend2d),
	                    ("cptbuild",    _register_cptbuild),
	                    ("gravfft",     _register_gravfft),
	                    ("grdrotater",  _register_grdrotater),
	                    ("talwani2d",   _register_talwani2d),
	                    ("talwani3d",   _register_talwani3d),
	                    ("greenspline", _register_greenspline),
	                    ("gmtflexure",  _register_gmtflexure),
	                    ("grdflexure",  _register_grdflexure),
